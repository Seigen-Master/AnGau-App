...
import { User, Phone, Mail, Home, Stethoscope, Briefcase, Users, Building, MessageSquare, Book, AlertTriangle, Info, Calendar, Edit2, Clock, UploadCloud, Download, Trash2, FileText, Eye } from 'lucide-react';
...
interface PatientDetailCardProps {
    ...
    onDocumentDelete?: (documentUrl: string) => Promise<void>;
...
export default function PatientDetailCard({ patient, onEditClick, onDocumentUpload, onDocumentDelete, isAdminView = false }: PatientDetailCardProps) {
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <div className="flex items-center space-x-2">
                                <Button onClick={() => fileInputRef.current?.click()} variant="outline" className="flex-1">
                                    <FileText className="mr-2 h-4 w-4" /> {selectedFile ? selectedFile.name : "Browse Files"}
                                </Button>
                                            ...
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    ...
                                                    <AlertDialogFooter>
                                                        ...
                                                        <AlertDialogAction onClick={() => handleDeleteClick(doc.url)}>Delete</AlertDialogAction>
                                                    </AlertDialogFooter>
                                                </AlertDialogContent>
                                            </AlertDialog>
                                        )}
